    ...
    <div style={{ height: 400, width: "100%" }} className="action-table">
      <Box>
        ...
        <Typography className="action-state">
          Below is a list of compliance applications which are ready for your
          review. Please download the applications and filing information.
          Should you have any questions, please contact us at{" "}
          <span>admin@thecozm.com</span>.
        </Typography>
      </Box>
